...
@section('content')
            ...
            <div class="row">
                <div class="col-sm-7">
                    <div class="header-text">
                        ...
                        <p>Intera offers all the premium features you might need without charging the earth for them. Get your server off the ground in as little as 5 minutes!</p>
                        <h4>Starting at</h4>
                        <h3>{{Price::getCurrencySymbol()}}{{Price::getPlanPrice(Config::get('plans.planList')[0]['name'])}}/monthly</h3>
                    </div>
                    <div class="buttons">
    ...
    <div class="pricing-tables custom-pricing padding-top50 padding-bottom50" id="plans">
        <div class="custom-width">
            <div class="row">
                ...
                @if($plan['showDefaultPlans'])
                @include('components.plan.plan', ['plan' => $plan])
                @endif
                @endforeach
    ...
    @include('components.plan_recommender')
