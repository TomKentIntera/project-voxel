...
NODE_IP='__NODE_IP__'
ORCHESTRATOR_BASE_URL='__ORCHESTRATOR_BASE_URL__'
WINGS_CONFIG_B64='__WINGS_CONFIG_B64__'
WINGS_URL_AMD64='__WINGS_URL_AMD64__'
WINGS_URL_ARM64='__WINGS_URL_ARM64__'
...
BASH;
        ...
        return strtr($template, [
            '__NODE_ID__' => $this->shellSingleQuote($nodeId),
            '__NODE_TOKEN__' => $this->shellSingleQuote($nodeToken),
            '__NODE_IP__' => $this->shellSingleQuote($nodeIp),
            '__ORCHESTRATOR_BASE_URL__' => $this->shellSingleQuote($orchestratorBaseUrl),
            '__WINGS_CONFIG_B64__' => $this->shellSingleQuote(base64_encode($wingsConfigJson)),
            '__WINGS_URL_AMD64__' => $this->shellSingleQuote($wingsBinaryUrlAmd64),
            '__WINGS_URL_ARM64__' => $this->shellSingleQuote($wingsBinaryUrlArm64),
            '__MONITOR_INSTALL_BLOCK__' => $monitorInstallBlock,
        ]);
    }
